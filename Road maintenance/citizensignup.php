...
<form action="citizenconnect.php" id="#form" method="POST" name="#form">
<div class="content">
  <div class="container">
    <h1>SIGN UP</h1>
    ...
    <input type="text" placeholder="Enter id" name="citizenid" required>
  ...
  <?php
include "citizenlogin.php";
?>
  
  <div class="container signin">
    <p>Already have an account? <a href="third.html">Log in</a>.</p>
  </div>
</div>
</form>
